...
class Planner(Node):
    def __init__(self):
        ...
        self.sub_odom = self.create_subscription(Odometry, '/odom', self.on_odom, self.qos_profile)        # self.sub_laser = self.create_subscription(LaserScan, '/j100_0707/sensors/lidar3d_0/scan', lambda msg: self.obs.assignObs(msg, self.config), self.qos_profile)
    ...
    def calc_to_goal_cost(self, trajs):
        print("trajectory shape", trajs.shape)
